    ...
    public static void main(String[] args) throws Exception {
        ...
        while (running == true) {
            ...
            if (selection == 1) {
                ...
                System.out.println("Option 2. One day viewing students, professors, assignments, and classes will live here");
                get();
            } else if (selection == 3) {
                System.out.println("Option 3. One day viewing students final grades will live here");
...
//                }
                ...
                System.out.println("Option 4. One day you will be able to edit existing entries here. ");
                update();
            } else if (selection == 0) {
